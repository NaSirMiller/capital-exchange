...
import "package:capital_commons/features/business_dashboard/cubit/business_dashboard_cubit.dart";
...
class BusinessDashboardPage extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (_) => BusinessDashboardCubit()..loadBusinessData(),
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        state.message ?? "Couldn't load business data",
                    ...
                    SliverPadding(
                      ...
                      sliver: SliverList(
                        delegate: SliverChildListDelegate([
                          ...
                          // Stats Overview
                          StatsOverview(business: business),
                          const SizedBox(height: 24),

                          // Funding Progress
                          FundingProgress(business: business),
                          const SizedBox(height: 24),
                          ...
                          if (isDesktop)
                            Row(
                              ...
                              children: [
                                Expanded(
                                  ...
                                  child: Column(
                                    children: [
                                      SharePriceChart(business: business),
                                      const SizedBox(height: 24),
                                      InvestorList(
                                ...
                                Expanded(
                                  child: Column(
                                    children: [
                                      DividendSchedule(business: business),
                                      const SizedBox(height: 24),
                                      QuickActions(
                                        businessId: business.uid ?? '',
                                      ),
                            ...
                            DividendSchedule(business: business),
                            const SizedBox(height: 24),
                            QuickActions(businessId: business.uid ?? ''),
                            const SizedBox(height: 24),
                            InvestorList(businessId: business.uid ?? ''),
                          ],
